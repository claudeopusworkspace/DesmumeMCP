...
def _configure_logging() -> None:
    ...
    Log file lives at ``<data_dir>/desmume_mcp.log`` (next to savestates, etc.).
    Rotates at 10 MB, keeps 3 backups.
    """
    data_dir = Path(os.environ.get("DESMUME_DATA_DIR", Path.cwd()))
    log_path = data_dir / "desmume_mcp.log"
