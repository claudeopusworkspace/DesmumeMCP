...
class HLSStreamer:
    ...
    def _start_ffmpeg(self) -> None:
        ...
        cmd = [
            ...
            "-hls_segment_filename", str(self._hls_dir / "segment_%05d.ts"),
    ...
    def _on_cycle(self) -> None:
        ...
        # Drain audio samples generated by this cycle
        audio_data = emu.audio_read()

        # Push to writer queues (non-blocking — drop if full)
        try:
            self._video_queue.put_nowait(raw_rgb)
        except queue.Full:
            pass  # drop frame rather than blocking emulation
