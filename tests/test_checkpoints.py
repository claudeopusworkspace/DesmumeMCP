...
from desmume_mcp.emulator import Checkpoint, CheckpointManager, EmulatorState
...
class TestToolIntegration:
    ...
    def test_tap_touch_screen_creates_checkpoint(self, holder):
        from desmume_mcp.server import _tool_tap_touch_screen
    ...
    def test_run_macro_creates_checkpoint(self, holder):
        ...
        from desmume_mcp.server import _tool_run_macro
    ...
    def test_list_checkpoints(self, holder):
        from desmume_mcp.server import _tool_list_checkpoints, _tool_press_buttons
    ...
    def test_revert_to_checkpoint(self, holder):
        from desmume_mcp.server import (
